...
class AdminBetaPage extends StatefulWidget {
  const AdminBetaPage({Key? key}) : super(key: key);

  @override
  _AdminBetaPageState createState() => _AdminBetaPageState();
}
...
class _AdminBetaPageState extends State<AdminBetaPage> {
...
Future<void> fetchConfirmedBookings() async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Admin - Alpha PC Management",style: TextStyle(color: Colors.white),),
